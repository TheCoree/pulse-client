...
function TimePickerInputGroup(props: DivProps) {
  ...
  return (
    <TimePickerInputGroupContext.Provider value={inputGroupContextValue}>
      <PopoverAnchor render={<InputGroupPrimitive role="group" id={inputGroupId} aria-labelledby={labelId} data-slot="time-picker-input-group" data-disabled={disabled ? "" : undefined} data-invalid={invalid ? "" : undefined} {...inputGroupProps} className={cn(
                    ...
                    } ref={composedRef} onPointerDown={onPointerDown} onClick={onClick} />}></PopoverAnchor>
